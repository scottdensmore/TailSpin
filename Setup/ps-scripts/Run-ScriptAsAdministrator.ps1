$ScriptPath = Resolve-Path($args[0])
$ScriptName = $args[1]
$ScriptFilePathToRun = Resolve-Path("$ScriptPath\$ScriptName")

# Run as administrator
$sh = new-object -com 'Shell.Application'
$sh.ShellExecute('powershell', "-f $ScriptFilePathToRun $ScriptPath", '', 'runas')
# SIG # Begin signature block
# MIIbXgYJKoZIhvcNAQcCoIIbTzCCG0sCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU2T+2dkFgrjJa4fjecVsuymOV
# +ASgghXnMIIEhTCCA22gAwIBAgIKYQh3XwAAAAAASjANBgkqhkiG9w0BAQUFADB5
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFHD6Hi2w
# MVtW/H+VXOpruH8AImaAMIGsBgorBgEEAYI3AgEMMYGdMIGaoHCAbgBwAGEAdAB0
...
# BgkqhkiG9w0BAQEFAASCAQA/737oX76gXVreVjSpjTY+5pc4IzDkhLCr5vL7yRHq
# R3T3M4Mb2r4loDrktBViLIngBG1IsjjH2mpM7RIzhr5jgW4TrFDg20QTb6t0xRYe
# s2x2WzO/yn68g+BfxhTg068CFsqyMf1n6s+pmhLnINleLvm63A3ekIUjSE41UkN9
# oZv/03g2Bdak+keqHK315FyvvuM8Nx114HB2NC07C4VbXpVJoVsL90d2mAmf0hFW
# Tr4CDSUKZGjx9y3IcbcQ/KJFthiHCI51puu04qCi9/eC4mJeHU11SSNgbOfWQ//o
# GSEG/VXsH2DPHMdx0X8q3a1khBv00DfVcdjSpn1nl41coYICHTCCAhkGCSqGSIb3
...
# KoZIhvcNAQkFMQ8XDTEwMTAyNzE5NTkxM1owIwYJKoZIhvcNAQkEMRYEFIPgambi
# 9TQFTEixqvWJdfUQDWzXMA0GCSqGSIb3DQEBBQUABIIBAAD8+uIbk0KvaZAMQqP4
# cfzxsuaInCL1lsnxJyE2PaSEI51TmyOyFC65gev1cBFGWXCRCh9DWPM8k0B+8pvd
# z2an+FKGd+Tv9G+hx5j7okZX/EIzefu3PjTrzGzi5uZNqY5GZVwwO0Cz3YLQdEXx
# 85aTtoTKlt6atGkKJ4GZsQXrqj0okz0ig3+JSnzLOD4WAhxnf2eWJzKQEM8dUyS3
# XBOmPNlKanEG6oHlwPOCIw+MgiG3HoaPMpEf2OClCJ005fznufcgO10CBGuhnPEC
# dHQ8gjlBaY+oQgVIUO24uJemcjynhPfogHLvFamrEKQOuH3ExfeYav7jwpknUPWN
# wj8=
