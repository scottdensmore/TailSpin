...
# Check IIS 7
$found = Check-RegistryValue -PropertyPath 'HKLM:\SOFTWARE\Microsoft\INETSTP' -PropertyName 'MajorVersion' -PropertyValue 7
if ($found -eq $false) { return $false; }

# Check IIS feature
$found = Check-RegistryValue -PropertyPath 'HKLM:\SOFTWARE\Microsoft\INETSTP\Components' -PropertyName 'W3SVC' -PropertyValue 1
if ($found -eq $false) { return $false; }

# Check IIS - Management scripts and tools feature
$found = Check-RegistryValue -PropertyPath 'HKLM:\SOFTWARE\Microsoft\INETSTP\Components' -PropertyName 'ManagementScriptingTools' -PropertyValue 1
if ($found -eq $false) { return $false; }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUnHQjxUMhEzGEsOdimKAgdwaM
# +L6gghXnMIIEhTCCA22gAwIBAgIKYQh3XwAAAAAASjANBgkqhkiG9w0BAQUFADB5
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFHUQaWCh
# wHRnq5sA5QuuQyz7QWMwMIGsBgorBgEEAYI3AgEMMYGdMIGaoHCAbgBwAGEAdAB0
...
# BgkqhkiG9w0BAQEFAASCAQBbYqjWl/CUJpqIgrn3ewPbHw4CC1euMm1LNLdrljh1
# SFO8toZ8eISWVALD4BrtyhNxFOSF3XF6cJDovCQaJwu4ghkSqIU9IX0GOKh6ign/
# xSeUoCRGkRm4Ae7FfG7bpLzlYHsDJTK+k+we8V4P0/1flkUCeboa9UL+WbwuCjO4
# tRC8SuOW/fWLlFowLM1HAYHY8q+otQOOp1ZUau+hHEyqL1eIomjrbwbGPeNXU5/m
# uxSW7rACDxNsGXew1U/d5cybMu6iPb1GScnLf6O8muAWNFx4Ww+9bkwLNHYag2jx
# Qp/l+LzubSk5UToYZ/FpH/UXj6ezNBGijUoSPemJxUc7oYICHTCCAhkGCSqGSIb3
...
# KoZIhvcNAQkFMQ8XDTEwMTAyNzE5NTkxNFowIwYJKoZIhvcNAQkEMRYEFMlGppUi
# lWi5RYgKpHmK6LO8MY0NMA0GCSqGSIb3DQEBBQUABIIBAGEHYQQ0gQAp1zPeRYOl
# TGUvQgxdhbnLweoOP1KIca+D0jYXtu9u++AM4SMgp/0820M3BkDHOy2sK/XyGQjB
# JIDzzUAzxPyoJf7mNnKIcgaFYOkjPLTV/NE5wphnaDa3OQyW/K8AFJiRd3n2Zysx
# SNb0dG/3qxLbaQNRS+vnVBXEXh9yCYoWoSge+c4i3l7Sij5tSmc/6wVNBr0u2GGR
# YpJsTrrJrfY54l4+CfMugA7IcL770F7rscdWyxZf/qzim1G5GHwT1+G9S39IBwzm
# QPjEWSWRePdTAOHc/tW2Q4GBI0ELNFlZUOiAY5PXgiMs91UPYbuGHxsv5wqEnoTN
# KnE=
