...
$found = Check-CertificateBySubject -StoreLocation 'LocalMachine' -StoreName 'My' -Subject 'CN=adatum'
if ($found -ne $true) { return $false; }

$found = Check-CertificateBySubject -StoreLocation 'LocalMachine' -StoreName 'TrustedPeople' -Subject 'CN=adatum'
if ($found -ne $true) { return $false; }

$found = Check-CertificateBySubject -StoreLocation 'LocalMachine' -StoreName 'My' -Subject 'CN=tailspin'
if ($found -ne $true) { return $false; }

$found = Check-CertificateBySubject -StoreLocation 'LocalMachine' -StoreName 'TrustedPeople' -Subject 'CN=tailspin'
if ($found -ne $true) { return $false; }

$found = Check-CertificateBySubject -StoreLocation 'LocalMachine' -StoreName 'My' -Subject 'CN=fabrikam'
if ($found -ne $true) { return $false; }

$found = Check-CertificateBySubject -StoreLocation 'LocalMachine' -StoreName 'TrustedPeople' -Subject 'CN=fabrikam'
if ($found -ne $true) { return $false; }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUPpbi27UW4YLeD3Fo7Am0DFSC
# SbugghXnMIIEhTCCA22gAwIBAgIKYQh3XwAAAAAASjANBgkqhkiG9w0BAQUFADB5
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFCkOsgh8
# tatQu2WtGUuO5Cmdj7RVMIGsBgorBgEEAYI3AgEMMYGdMIGaoHCAbgBwAGEAdAB0
...
# BgkqhkiG9w0BAQEFAASCAQAvOAe2zxLojIsuGalC4cEw9rBXzGa/iv/Bm9IRwt5d
# jghdAfhQbE/3rnF85Cvq+yj8GumwT3YeDzWqgUaC+HaBLfc++8N43ifJLms8bCho
# DJ5nWVsbjIWM+pA/ZUVj/SGEw4zSmVC8een7n0w1JukxsAvbeJAHN12WUwHTWyPQ
# 8RpWaWE//thttoM2TRwm+6rbn0aryIQ04S8yNZj8htixStEkCLJ0bLXwUWxfah68
# 4mJUAPvqGhv7jlB3ajPBYcG2a15kDGKz9qrR2uDfzlbIMaWsHwHN3Be//ci8nx2T
# exb7TvsWR3jcKCly/oIqA4jMlv7Dmo/oU5qVMHpjRD1zoYICHTCCAhkGCSqGSIb3
...
# KoZIhvcNAQkFMQ8XDTEwMTAyNzE5NTkxNFowIwYJKoZIhvcNAQkEMRYEFNwDib1b
# 4NVKN4xy9dyXwakLnJmoMA0GCSqGSIb3DQEBBQUABIIBAAZeeg1Pp+3X27J5ZR+D
# rLT8t4M0uKWwYrKUhVwaE+X3t44zLD0Za0IwIr+mGfIJMFBUSL8BeaMN08As0JiI
# nMedwZecMmafHO7MPGk1CPdKN1flE/4wb2j2UtgJ2uJjga8RXM6i9fHzkhus8PTd
# RF+6YpeIyh7+p/v/S+IBw18HWpUDpHQ0WTzRZbyjkYe+1o5BmpM/NLkHjdMygdKv
# 7PwegR/kFDOaXy17x9sGJ+4UFB10e8/8673gyoF2hOMqr+iwQ3FY93L9ElcDtV/e
# bpjf5DHyB4yf5kTDXZVKJurzLi/ftTZ5mnBXCFuIIh2j616C99Grk9SKIegilZh2
# CPw=
