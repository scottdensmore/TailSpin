...
# Azure tools 1.2 for VS2010 x84
$res = $res -or (Check-RegistryValueGreaterThanOrEqualTo -PropertyPath 'HKLM:SOFTWARE\Microsoft\Windows Azure Tools for Microsoft Visual Studio 2010\1.0' -PropertyName 'FullVersion' -PropertyValue '1.2.30517.1601');

# Azure tools 1.2 for VS2010 x64
$res = $res -or (Check-RegistryValueGreaterThanOrEqualTo -PropertyPath 'HKLM:SOFTWARE\Wow6432Node\Microsoft\Windows Azure Tools for Microsoft Visual Studio 2010\1.0' -PropertyName 'FullVersion' -PropertyValue '1.2.30517.1601');

$res
# SIG # Begin signature block
# MIIbXgYJKoZIhvcNAQcCoIIbTzCCG0sCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQURPp3UGgmz8G3x23sERZxqsqo
# 2I2gghXnMIIEhTCCA22gAwIBAgIKYQh3XwAAAAAASjANBgkqhkiG9w0BAQUFADB5
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFOiQxGqk
# +gEoYayrsKBEolRH+33AMIGsBgorBgEEAYI3AgEMMYGdMIGaoHCAbgBwAGEAdAB0
...
# BgkqhkiG9w0BAQEFAASCAQA9Pt4Hq18krCkAjbGPccCTEXlYhi/m1Tcb65QKowhd
# I5PY3hEwwSirgnqvgmDI7R37cUi0w9dGFylK9nM5fUWQs7d0RMmm25O7QAc3zK+n
# 2/3o2I9wD9IUSIiuulvppa6ZobJwixPkKtmMUqOdW3Q/9JMz8mTSflFIHTYo1Iad
# xEFi75NRUKoGsa4aS8QsA+K7e4m5xPZXiBo4iQBW+PBFVK+pGqDH+vuM4rtPpYlg
# Vv+LszXA/TNvguLG91+UUQfxMxhV6hcFAqINSoUwP8w8KJxe6ev8Gfns8RDfJzmL
# inGmzFJGAbsUQC+WpWaOs1Oi+PLmK77zVzci2QVtktixoYICHTCCAhkGCSqGSIb3
...
# KoZIhvcNAQkFMQ8XDTEwMTAyNzE5NTkxNFowIwYJKoZIhvcNAQkEMRYEFB9Buqlh
# VWcDbzLFZgQXjCDAT63AMA0GCSqGSIb3DQEBBQUABIIBAGCtAFadQ0qFqrQe5ggg
# 78J/n2xnpApfYu7mbFxnREXHyUWjiRNc5gDJvPrnCjM6BePEdKvy5DiBkuZ4PUgx
# oEjhWIEtoKboGVxWZoY1bJYm/FqleUNuaulmqTdDVredQlMhoZYV1wQx3hxsOiR3
# w7aw/DCHPQhb1I0Uc/S0PKx30A8RWnyyn2zKit8RfjT10/je6g0FlNDEO3ojZGTb
# 6PoPPpaxH1CuwCwDrP+h1MeOFZLE1jPkq7+iNf7VD/NjJiYA73tHDPtlyjqIRIx+
# 0JaisRN3U79S8qZGBKhrxGFlGqsuLLhKPNRvPdvysgMrocpd3jekfSJIAj20K8BK
# Du4=
