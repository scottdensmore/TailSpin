function Check-RegistryPath($Path)
{
...
function Check-RegistryValueGreaterThanOrEqualTo($PropertyPath, $PropertyName, $PropertyValue)
{
	if ((Test-Path -path $PropertyPath) -ne $True) 
	{
		return $FALSE;
    ...
    if($entryProperty.psobject.Properties -ne $null)
    {
        ...
        if(($registryValue -gt $PropertyValue) -or ($registryValue -eq $PropertyValue))
        {
            $found = $TRUE;
        }
    }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUPlQE43QuRJq/o9VqZGPjWa6y
# VCSgghXnMIIEhTCCA22gAwIBAgIKYQh3XwAAAAAASjANBgkqhkiG9w0BAQUFADB5
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFFjKLQME
# nJIHeOkqhEtzugqSia87MIGsBgorBgEEAYI3AgEMMYGdMIGaoHCAbgBwAGEAdAB0
...
# BgkqhkiG9w0BAQEFAASCAQAppsjBZal5kUB3SEZGlWOD0UrbswdA3bLo2HKJ7fMt
# tEGTYlWpodCXRXXGgUNJVBXgfkwV85WzX/UGcjNoVV9PUltw/ygM0n7vtxCn6x/r
# l4uaOmHiZm0Rg8w93B4am4zrN8S0TLZEELU1+voUUQ/KVM6rJxcon38I4KRZ5U1t
# 5YHUwRgjkBXAcU46oBwK5+QVFyjzfkaepYd9ojuYQjdcF95kKWp2+g7hAETZ8gc3
# 1ZPpiV65bSF0ODN6bsnB+OIA2jwK+JoBpKjf3XY31pgAEpdOqmvpXAn2XNjf1lia
# 9gy6khMN0g1pTQ3F+FLwhlmEiqFf9qCksUDqAn91XyoZoYICHTCCAhkGCSqGSIb3
...
# KoZIhvcNAQkFMQ8XDTEwMTAyNzE5NTkxNFowIwYJKoZIhvcNAQkEMRYEFCXVI69q
# CWquL8OIh/oySIzh3A6bMA0GCSqGSIb3DQEBBQUABIIBAJmyftoX7t+/ZE9gIC1m
# mEGGDTZLScKWnf33dm7noKn4YVyLI+Un03qq6eOIxAD9YJhe+CA96RvNXlf6irtM
# uXL1/hnaPBjT+6/32DSRfPnov3qaSdsTKW0Jj/9fcHCfzNdaZM4dOWwANTEBQ+Hf
# OQXvkAwSeRrbiLlqS9PZvvkAulrDSK4fT4FFUpFvEd1ybW4pJoaIazMjP17FAGbd
# vNW/UACCuoEBwtuzSX8/ICzEJmtmIRFVkGUigwnbBUZAjIGVy0wZIQgAqT27vgy1
# ychDv/LJyAiKxW2ZY6UQ46LtNXJ2E4hj2eTqMPc4CdKDCDKiPjqXGSJrFpkfJIgo
# cvw=
