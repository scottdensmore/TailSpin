...
function Create-WebApplication($PathOfTheSample, $ApplicationName)
{
    if ((gwmi -namespace "root/WebAdministration" -query "select * from Application where Path=""/$ApplicationName""") -eq $null)
    {
        invoke-expression "$env:windir\system32\inetsrv\appcmd add app /site.name:""Default web site"" /path:""/$ApplicationName"" /physicalPath:""$PathOfTheSample\$ApplicationName"" /applicationPool:""ASP.NET v4.0""" 
    }
}

# (Starting from the path where the application is running)
$basePath=resolve-path ..\

Create-WebApplication -PathOfTheSample "$basePath\SourceCode\Shared" -ApplicationName 'Adatum.SimulatedIssuer.wp7'
Create-WebApplication -PathOfTheSample "$basePath\SourceCode\Shared" -ApplicationName 'Fabrikam.SimulatedIssuer.wp7'
Create-WebApplication -PathOfTheSample "$basePath\SourceCode\Shared" -ApplicationName 'TailSpin.SimulatedIssuer.wp7'

return $true;
# SIG # Begin signature block
# MIIbXgYJKoZIhvcNAQcCoIIbTzCCG0sCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUaDfvxO2LgXFxohZe0fcFhHl9
# f7KgghXnMIIEhTCCA22gAwIBAgIKYQh3XwAAAAAASjANBgkqhkiG9w0BAQUFADB5
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFNx9rqpH
# 7Y4mnGLpFRtJJLjuV7FcMIGsBgorBgEEAYI3AgEMMYGdMIGaoHCAbgBwAGEAdAB0
...
# BgkqhkiG9w0BAQEFAASCAQBki81Ui0Uf888da3pTLWqeJojrV0rx8IaVSTv20ozM
# BNV5a9HE43QSMT7mOZWxNNzotwmcOSZx14E+euhf5O3Jmkjb6rMcABkVXPwMzuyU
# 0xT9Xv22IIhq+jvPOTmgMx53F1P65lGYY0TeiVd0aqyiTkQXUT3B/UDQhfWR5TlS
# 198bUzgnV5PhcSCNLsNXwlfy5YIC6tFtR8e02iFZ6BN4pObkITRuAap62hM0BWSU
# bXv4PCSbSuB+3UQfZJS2c4qfEfwEnYO9fRtc66NGy3pJvrMO+Xvc7XWUCw7p3hC0
# r88MT7jNyrqXZytmArq783ZGp03vXi98S2Jvfj3hZ1awoYICHTCCAhkGCSqGSIb3
...
# KoZIhvcNAQkFMQ8XDTEwMTAyNzE5NTkxNFowIwYJKoZIhvcNAQkEMRYEFLdCK515
# 1i7x2K3ksf6fhF+zyyZxMA0GCSqGSIb3DQEBBQUABIIBAErK2etfWhWyW18U5sq9
# yR3ZmYujJR9AjSMXRZM3c2m/PPpfP2MIR1i33SmKEgot85DzdxevHVQgf7UuVCu7
# QAEZ4dvcxv8LAEXSKHlC9voPTqZv6vFJ+iRLTF23eFfnBtBXtOz5lX7muuaBpbo8
# FSCtRyo+7aUGbffg7IvgbIK/NzV+DM+Atgoo/oOo2tWyol33Dq9ESyOaK8dtaPH9
# bqRfehhFDO22Q4nqohONEDNheKfX/fFLvMBmeea3vxLjHEaXVvsoAFCeO0GUr6PI
# Y0/pyCA99RhZ2Nr4ybt9oRfRihgSuJktcx8PRoVZUDbyLlIEkNO2W0Xlfm3I0EDn
# htQ=
