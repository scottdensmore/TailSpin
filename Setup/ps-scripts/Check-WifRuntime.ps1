...
$res = $res -or (Check-RegistryValueInChilds -PropertyPath 'HKLM:SOFTWARE\Microsoft\Windows Identity Foundation\Setup' -PropertyName '(default)' -PropertyValue '6.1.7600.0');
$res = $res -or (Check-RegistryValueInChilds -PropertyPath 'HKLM:SOFTWARE\Wow6432Node\Microsoft\Windows Identity Foundation\Setup' -PropertyName '(default)' -PropertyValue '6.1.7600.0');

$res
# SIG # Begin signature block
# MIIbXgYJKoZIhvcNAQcCoIIbTzCCG0sCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUJU/MgmBLq48qd7td5QYDq3od
# x/mgghXnMIIEhTCCA22gAwIBAgIKYQh3XwAAAAAASjANBgkqhkiG9w0BAQUFADB5
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFFZaTqX3
# jdotHNOoNgofVgsLLTtLMIGsBgorBgEEAYI3AgEMMYGdMIGaoHCAbgBwAGEAdAB0
...
# BgkqhkiG9w0BAQEFAASCAQC9c9c30AeeWQi3MX3oOmWlGcVmxgly69lE+300Hr+E
# nf7Aa8Z6YOfH1beQnRVq8eIaYeARfDIj7ZlF82tq/5Mrb4e5X0LRiojA0Qfut/sB
# YePyH4AwyOdsNeOhUDwWpxI60wACdXmridp2D/VVra2izLIgJg52sQKt4wGvp/Dw
# XAxzxzzhfVvdQ2+/HQHT+XAn9em7gRnpVSBwAaGmmQUmQ01UWUGTSS8uiJl4MBlM
# WFgZ47KU5dVHogkTlMa0b2qT77h6CBPdEGjOwSOf6fVrolP68+TNQtin0lrLRbKV
# 7RIw/NQjp69i5XuJ7/5XpuBtaK1OFvV3KX6BKTrvY5uYoYICHTCCAhkGCSqGSIb3
...
# KoZIhvcNAQkFMQ8XDTEwMTAyNzE5NTkxNFowIwYJKoZIhvcNAQkEMRYEFATTt3CY
# 8XgvsRlTY0ab/hf/h5yRMA0GCSqGSIb3DQEBBQUABIIBACZuEqq9KG0vDDF+MF1H
# NEwNBPaCesixhLq4GplwnlxRN01gKKRND+weew5zncvirAeCQPZGy6foRrXIFMX8
# i8pEVaFUAX8TDvKXHYYn9LkiPzAlQTxnItpGaYlUlUzf1ClgnrMf3/p+fiPMDkDu
# IzxHBnZ8YZ9XbY3DTS9tLjMxnhuK4l+vyMJd/0FBbaQ6v7x0G7J88iymRa/PbzoS
# Ob5q6s29Cr8CecZClysn+SLz7iR8XMwhwjee76/VOuxMIkL2TjhDi5pn7N4wGx7j
# JK6k3FxZ7xkTrbNLdpPp7g2Z/KyGQuDl+V4C1OPAqsG8oBieSymZv4XCk8nynEud
# 3To=
