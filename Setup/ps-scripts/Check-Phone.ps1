...
# Windows Phone 7 x86
$res = $res -or (Check-RegistryPath -Path 'HKLM:SOFTWARE\Microsoft\XDE');

# Windows Phone 7 x64
$res = $res -or (Check-RegistryPath -Path 'HKLM:SOFTWARE\Wow6432Node\Microsoft\XDE');

$res
# SIG # Begin signature block
# MIIbXgYJKoZIhvcNAQcCoIIbTzCCG0sCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUfpNrwzwNblao+7kZHvqFFxjo
# F2qgghXnMIIEhTCCA22gAwIBAgIKYQh3XwAAAAAASjANBgkqhkiG9w0BAQUFADB5
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFNaL1RIh
# GCGfXdaET00eXpL69S2IMIGsBgorBgEEAYI3AgEMMYGdMIGaoHCAbgBwAGEAdAB0
...
# BgkqhkiG9w0BAQEFAASCAQA6ozQQ0FBXy9qXzYsuopcxUNk507HkmO98qfZqPPgv
# Co2mKn0SMb+pc+nilkVhn79zUuZ2LcNVScDHz8yOcDNG+R0JULeLc76IsJB8wd6M
# f9uH2ZcqR2I3VsY4Coi0KmN0mb5asXJpHvyFqEJiQRj5WxTpmAw5M7UE27G9N12S
# zzdpuzvmAyURm+i1GadBbaS9fXlsrQg3N28F/OgL0y8doh/1V6RrHcK5ERSQBvRQ
# JCzGaAkivm9DJxZ5HhH4lMboUqqiZlna/73bxznIUMbU5WFSKmMLp/pIsnsgYnRn
# UxKUwr1P/2oyO1hQb7jIIfn+5wxD4ZAeIO/9QJMiu88noYICHTCCAhkGCSqGSIb3
...
# KoZIhvcNAQkFMQ8XDTEwMTAyNzE5NTkxM1owIwYJKoZIhvcNAQkEMRYEFAxM7PRA
# A49DUNLzyFwie6iTjdmPMA0GCSqGSIb3DQEBBQUABIIBAEDs4L+x2vIc6bIqH4Mp
# RVLKdzjQdpn+GNoquKh6AY2rJiVAfTnHqS9A8uXYftKJGjicqtM5XUWer/tSVPlo
# WrIwuj2v3arKDDWoTg0kXFSoZUi34z4Q0SUXJ+96KU/IN2gg911RdDRaS6SCPIvC
# OvpA4xJpmHfqDOHh/0FU+OIlrLe1/1511lU5Mfm2C1X4olh7TGILMSp3bGfu5zK9
# g6kgvNL9ieFS51rZiUbG+qSHF5zrEh4nuU+m15cY6qElBeRSwH6gNixpmxc3a9f5
# EheA4piRzcpA4WINtUZnzinXn5BepLKKBMbcmVBfcV6hKMxcDxWbwvWl5yQ6GVDd
# NR8=
