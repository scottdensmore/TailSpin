& $env:windir\system32\pkgmgr.exe '/iu:IIS-WebServerRole;WAS-WindowsActivationService;WAS-ProcessModel;WAS-NetFxEnvironment;WAS-ConfigurationAPI;IIS-WebServer;IIS-DefaultDocument;IIS-StaticContent;IIS-NetFxExtensibility;IIS-ISAPIExtensions;IIS-ISAPIFilter;IIS-RequestFiltering;IIS-ASPNET;IIS-WindowsAuthentication;IIS-IIS6ManagementCompatibility;IIS-Metabase;IIS-ManagementScriptingTools;' | out-null
# SIG # Begin signature block
# MIIbXgYJKoZIhvcNAQcCoIIbTzCCG0sCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU98GqFoiIr2PDgN5EIDbKGzVn
# XdagghXnMIIEhTCCA22gAwIBAgIKYQh3XwAAAAAASjANBgkqhkiG9w0BAQUFADB5
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFJJLL1I6
# CDxtM/nqruy1t6YpzSX0MIGsBgorBgEEAYI3AgEMMYGdMIGaoHCAbgBwAGEAdAB0
...
# BgkqhkiG9w0BAQEFAASCAQAWbj2lCw155wc+5Z7Eh4UwodBOAOwZebsiLpuhhMAi
# +w54Qyp3FGBIplzjTiFRKB0DrDbGWRLE8FBhcNcpmWMt94zDt57xpDJoNaQRqpuF
# bHQetPs5L9GM4x+mfDCSgBH+rRHj7YI7eSAjERgn3Yp3Chn6Dg0AWWVm3nl5dykg
# UIMZPKOcpAvKZ7Jsk51NQ0vfUc5sRah6jI6o4sMk42Fh/+IoKX50qcuXUY16mb8v
# 7Qgc792+DgQK+3ujNkAfEw7dkYfL9aJrN0tOa7mi1n6ddAAKBNT3NCK0GNR42cgl
# FurQn554dNPMhurnbGHIVM0crl60y63fHYoBYm+Q1MgUoYICHTCCAhkGCSqGSIb3
...
# KoZIhvcNAQkFMQ8XDTEwMTAyNzE5NTkxNFowIwYJKoZIhvcNAQkEMRYEFIcG7Imn
# 9aN8FhH8A4jdjujFHBOqMA0GCSqGSIb3DQEBBQUABIIBAI9V+ENpq5HWShbOaN3P
# uu9JeWatWiEwz859ml/+7EREbF9h9mpcRMClo5K4L8Ed15P2LFScCdYXYh+m6/tw
# aXzCHf4BcXFKICaVMuHJvx7osxhC81TVr3H0Ou36d2A7UjcoWD+X1dUUzQIs5kRu
# Ze2R742lt9O52ZXR/r562B+Tr0oAOpK85l1RIOqgL2M/7609PmCL8iqA5qN1gsTt
# GVREWSY5hfybs8OPu37l1H0NhilrU+13bwLpdmSrzZBeDnOFUIiGbYAtXLc0TNJV
# muFaj7sIXh3+IDATmXkQ+xHjq2H3/IqVUuXi+1ge2vN0DxrAUmCQXn2lKWnsdBBh
# KIk=
