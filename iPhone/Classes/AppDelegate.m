...
static NSString *DATABASE_FILENAME = @"tailspin.db";
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {    
    ...
    DatabaseMigrator *migrator = [[DatabaseMigrator alloc] initWithDatabasePath:DATABASE_FILENAME inDocumentsDirectory:YES];
